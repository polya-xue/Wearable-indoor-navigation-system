...
public class BleDefinedUUIDs {
	...
	public static class Service {
		...
		final static public UUID HEALTH_THERMO            = UUID.fromString("00001809-0000-1000-8000-00805f9b34fb");
	};
	...
	public static class Characteristic {
		...
		final static public UUID TEMP_MEASUREMENT         = UUID.fromString("00002a1c-0000-1000-8000-00805f9b34fb");
	}
