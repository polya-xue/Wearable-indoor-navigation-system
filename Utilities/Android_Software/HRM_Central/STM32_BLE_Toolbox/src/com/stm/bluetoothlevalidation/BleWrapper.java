...
public class BleWrapper {
    ...
    private static final int RSSI_UPDATE_TIME_INTERVAL = 3000; // 3 seconds
    ...
    public void getCharacteristicValue(BluetoothGattCharacteristic ch) {
        ...
        else if (uuid.equals(BleDefinedUUIDs.Characteristic.TEMP_MEASUREMENT)) {
			try {
				tempValue = decodeTemperature(ch.getValue());
				DecimalFormat formatedTemp = new DecimalFormat("#0.00");
				strValue=(formatedTemp.format(tempValue)) + "°C";
			} catch (Exception e) {
