 ...
 */
#define BLE_NOTIFY_NO_EVENT                     (0x00)
#define EVT_BLUE_INITIALIZED           			(0x01)
#define EVT_CONNECTION_COMPLETE                 (0x02)
#define EVT_PASSKEY_REQUEST						(0x03)
#define EVT_PAIRING_COMPLETE					(0x04)
#define EVT_DISCONNECTION_COMPLETE				(0x05)
#define EVT_ADVERTIZE_ERROR						(0x06)
#define EVT_ADVERTISING_TIMEOUT					(0x07)
